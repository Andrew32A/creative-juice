...
const Signup = () => {
  ...
  return (
    <div
      style={{ fontFamily: "DM Sans, sans-serif", backgroundColor: "#F2E2C4" }}
      className="w-full h-screen bg-[#F2E2C4]"
    >
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <img
            ...
            src={Logo}
            alt="Creative Juice Logo"
          />
          <h1
            style={{ fontFamily: "DM Sans, sans-serif" }}
            className="mt-10 text-center text-4xl leading-9 tracking-tight drop-shadow-2xl font-bold text-[#3f3f3f]"
          >
            Create an Account to Start Juicing!
          </h1>
        </div>
        ...
        <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" onSubmit={handleSignup}>
            ...
            <div>
              <label
                htmlFor="email"
                className="block text-sm font-medium leading-6 text-[#3f3f3f]"
              ></label>
              <div className="mt-2">
                <input
                  id="email"
            ...
            <div>
              ...
              >
                ...
                <Link
                  to="/login"
                  className="nav-link text-black border-[#003000] border-2 px-4 py-1 ml-2 inline-flex items-center justify-center bg-[#BBF2E2] hover:bg-[#F2A7CA] transition duration-300 ease-in-out"
                >
                  <span>Log In</span>
                </Link>
              </div>
