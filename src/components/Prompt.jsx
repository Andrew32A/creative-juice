        ...
        <div className="max-w-[1000px] px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <div style={{  }}>
              ...
              }} className="text-4xl sm:text-6xl drop-shadow-2xl font-bold text-[#3f3f3f]">Welcome, Juicer!</h1>

              <p className="text-[#3f3f3f] py-4 max-w-[700px]">Here is your Creative Juice of the day. Share your drawing in order to see what other artists created today. Your drawing will be
              entirely anonymous.</p>
              <div style={{ border: '0.5px solid #3f3f3f' }}></div>
              <h2 className='mt-5' style={{ fontWeight: 'bold', fontSize: '17px' }}>Play 🎉</h2>
              <p className='text-[#3f3f3f]'>Draw a bumblebee helicopter zooming through a dorest of candy canes.</p>
              <h2 className='mt-5' style={{ fontWeight: 'bold', fontSize: '17px' }}>Do Something ⭐️</h2>
              <p className='mb-5 text-[#3f3f3f]'>Draw a bumblebee.</p>
              <div style={{ border: '0.5px solid #3f3f3f' }}></div>
              <div className='email-input-wrapper' style={{ display: 'flex', alignItems: 'center' }}>
              <Link
                to="/login"
                className="text-black group border-[#003000] border-2 px-4 py-2 my-1 ml-[-2px] mt-5 flex items-center bg-[#BBF2E2] hover:bg-[#F2A7CA] transition duration-300 ease-in-out z-20">
