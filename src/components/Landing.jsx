      ...
      >
        <div className="max-w-[1000px] px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <div style={{}}>
              <div className="intro-text text-[#3f3f3f] py-4 max-w-[700px] text-xs">
                YOU LOOK DEPLETED.
              </div>
              ...
              >
                You Need Creative Juice!
              </h1>

              <p className="text-[#3f3f3f] py-4 max-w-[700px]">
                Get{" "}
                <span className="font-bold text-[#3f3f3f]">
                  one creative drawing prompt
                </span>{" "}
                every day. Submit your drawing to see what other artists created
                for the same prompt. Juicy.
              </p>
              <div
              ...
              <p className="email-subtext text-[#3f3f3f] py-4 max-w-[700px] text-xs">
                We won't spam you. This is simply a fun experiment by artists,
                for artists.
              </p>
            </div>
            <div className="img-wrapper">
              <img
                className="w-[350px] mx-auto mt-1 ml-3"
                src={Logo}
