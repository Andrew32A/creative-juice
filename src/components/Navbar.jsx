        ...
        <ul className="nav-wrapper hidden md:flex space-x-4 text-pink-300">
          <li style={{ display: 'flex', alignItems: 'center' }}>
            ...
            {!isAuthenticated ? (
              ...
              <button onClick={handleLogout} className="nav-link text-black border-[#003000] border-2 px-4 py-1 ml-[-2px] inline-flex items-center justify-center bg-[#BBF2E2] hover:bg-[#F2A7CA] transition duration-300 ease-in-out">
