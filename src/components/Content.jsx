...
const Content = () => {
  ...
  return (
    <div className="text-center mt-8 mb-3" style={{ fontFamily: 'DM Sans, sans-serif'}}>
     ...
     <div className='rounded-md p-10 flex flex-col items-start'>
      
        <h2 className="text-2xl font-bold m-10 text-[#3f3f3f]">Is This For Newbies?</h2>
        <p className="text-[#3f3f3f] ml-7">This is for everybody who likes to make art! 
      ...
      <p className="text-[#3f3f3f] ml-7">
        ...
        <p className="text-[#3f3f3f] mb-3 ml-7">It's super simple. You'll get a new simple prompt and a more detailed one every day. You get to choose which you do that day. Submit whatever you draw, and you'll get to see the drawings other artists created for that prompt (likewise, they'd get to see yours)! All the drawings are anonymous.</p>
